...
import EditMemberCardStyle from "./EditMemberCardStyle";
...
class EditMemberCard extends React.Component {
  ...
  state = {
    ...
    qr_pdf_button_disabled: true,
    qr_wide_pdf_button_disabled: true,
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Vouchers \ Edit Member Card :: loadData");
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: onSubmitButtonClick");
      //console.log(evt);
      ...
      if(response.status === 'OK'){
        ...
        .then((response2) => {
          if(response2.status === 'OK'){
            ...
            if(DEBUG_CONSOLE){
              console.log("Edit Member Card :: loadData >>  listAvailableCurrencyService");
            ...
            .then((response3) => {
              if(response3.status === 'OK'){
                ...
                if(DEBUG_CONSOLE){
                  console.log("Edit Member Card :: loadData >>  listAffiliatesForCurrencyService");
        ...
        const refill_card_value = response.list_prepaid_cards[0].refill_allowed == "Y" ?
          {
            value: "Y",
            text: <FormattedMessage id="Yes" defaultMessage="Yes" />
          }
        ...
        this.setState(
          {
            ...
            qr_pdf_button_disabled: false,
            qr_wide_pdf_button_disabled: false,
          }
        );
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: onUpdateButtonClick");
      //console.log(evt);
      console.log(this.state);
    }
    ...
    const updateMemberCard = {
      ...
      //refill_card: this.state.refill_card["value"]
    };
    
    editMemberCardService(updateMemberCard)
    .then((response) => {
      if(response.status === 'OK'){
        if(DEBUG_CONSOLE){
          console.log(response);
        ...
        this.setState(
          {
            errorMessage: '',
            isErrorMessage: false,
            successMessage: this.props['intl'].formatMessage({ id:"Member card(s) successfully updated !", defaultMessage: "Member card(s) successfully updated !"}),
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("EditMemberCard :: onCancelButtonClick");
      //console.log(evt);
    }
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangeAffiliate");
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangeNumberOfDays");
      console.log(event.target.value);
    }
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangeExpiredDate");
      console.log(date);
    }
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangePromoCard");
      console.log(event.target.value);
    }
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangeRefillCard");
      console.log(event.target.value);
    }
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangeStatusCard");
      console.log(event.target.value);
    }
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangeGameClientQRCodeUrl");
      console.log(event.target.value);
    }
  ...
  {
    if(DEBUG_CONSOLE){
      console.log("Edit Member Card :: handleChangeBarcodeType");
      console.log(event.target.value);
    }
    ...
    return (
        <div className={this.props['classes']['content']}>            
            <Typography variant="h6" gutterBottom>              
              <EditIcon />
              <FormattedMessage id="Edit Member Card" defaultMessage="Edit Member Card" />
            </Typography>
            <Grid container spacing={24}>
                ...
                <Grid item xs={12} sm={12}>
                  ...
                  >
                    { 
                      this.state.list_refill_cards.map((value, index) => {
                        return <MenuItem value={ JSON.stringify({ value: value.value, text: value.text }) } 
                        key={index}>{value.text}</MenuItem>
                      })
                    }
                ...
                <Grid item xs={12} sm={4}>
                  <Button
                    ...
                    disabled={this.state.qr_pdf_button_disabled}
                  >
                ...
                <Grid item xs={12} sm={4}>
                  <Button
                    ...
                    disabled={this.state.qr_wide_pdf_button_disabled}
                  >
                    <FormattedMessage id="QR PDF Wide" defaultMessage="QR ODF Wide" />
                  </Button>
                </Grid>
...
const hoc = connect(mapStateToProps, mapDispatchToProps)(EditMemberCard);

export default withStyles(EditMemberCardStyle)(injectIntl(hoc));